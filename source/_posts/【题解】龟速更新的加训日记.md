...
我们将仅含一条非树边的环称作基本环，先累计基本环答案，再 $O(m^2)$ 枚举两条非树边，设各自形成的两个基本环分别为 $a,b$，容斥一下，新环长 $|c|=|a\oplus b|=|a|+|b|-2|a\cap b|$，又 $\gcd(|a|,|b|,|c|)=\gcd(|a|,|b|,2|a\cap b|)$，我们只用求 $a,b$ 在生成树上的交集长度，见[树链求交](https://github.com/KisuraOP/XCPC-Templates/blob/main/templates/02-%E6%A0%91%E8%AE%BA/Path_Union.cpp)。
