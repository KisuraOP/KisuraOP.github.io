!function(e, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define("detect", [], n) : "object" == typeof exports ? exports.detect = n() : e.detect = n()
}(this, function() {
    return function(e) {
        function n(i) {
            if (r[i])
            ...
            function i(e) {
                var n = e || t.userAgent
                  ...
                  , i = {
                    ...
                    360: n.indexOf("360EE") > -1 || n.indexOf("360SE") > -1,
                    ...
                    Tablet: n.indexOf("Tablet") > -1 || n.indexOf("Pad") > -1 || n.indexOf("Nexus 7") > -1
                };
                i.Mobile ? i.Mobile = !(n.indexOf("iPad") > -1) : d.showModalDialog && d.chrome && (i[360] = !0);
                var o = {
                ...
                r.device = "PC",
                r.language = function() {
                    var e = t.browserLanguage || t.language
                      , n = e.split("-");
                ...
                r.osVersion = "",
                c[r.os] && (r.osVersion = c[r.os](),
                r.osVersion == n && (r.osVersion = ""));
                var x = {
                    Safari: function() {
                ...
                r.version = "",
                x[r.browser] && (r.version = x[r.browser](),
                r.version == n && (r.version = "")),
                "Edge" == r.browser ? r.engine = "EdgeHTML" : "Chrome" == r.browser && parseInt(r.version) > 27 ? r.engine = "Blink" : "Opera" == r.browser && parseInt(r.version) > 12 ? r.engine = "Blink" : "Yandex" == r.browser ? r.engine = "Blink" : void 0 == r.browser && (r.browser = "Unknow App")
            }
            function o(e) {
                return new i(e)
            }
