...
!function(e, t) {
    ...
    return function(e) {
        ...
        var s = function() {
          ...
          , v = n(9)
          , m = n(25)
          , D = v.call(Function.call, Array.prototype.concat)
            ...
            for (var p = 1, d = !0; p < n.length; p += 1) {
                ...
                m(h, s))
                    ...
                    if (a && p + 1 >= n.length) {
                        var x = a(l, g);
                        d = !!x,
                        l = d && "get"in x && !("originalValue"in x.get) ? x.get : l[g]
                    } else
                        d = m(l, g),
                        l = l[g];
                    d && !c && (h[s] = l)
        ...
        var r = n(88)
          ...
          , f = function(e, t) {
            var n = arguments.length > 2 ? arguments[2] : {}
              , o = r(t);
            i && (o = u.call(o, Object.getOwnPropertySymbols(t)));
    ...
    , function(e, t, n) {
        ...
        u.default)(s.default, {
            ...
            unescape: function(e) {
                return e && b.test(e) ? e.replace(D, function(e) {
                    return w[e]
                }) : e
            },
    ...
    , function(e, t, n) {
        ...
        var r = n(9)
          ...
          , a = i("%Reflect.apply%", !0) || r.call(u, o)
    ...
    , function(e, t, n) {
        "use strict";
        var r, i, o = Function.prototype.toString, u = "object" == typeof Reflect && null !== Reflect && Reflect.apply;
        if ("function" == typeof u && "function" == typeof Object.defineProperty)
            try {
          ...
          , i = {
            ...
            build: function(e, t) {
                var n = /^(https?:)?\/\//i
                  ...
                  , u = ' <img alt="' + e + '" referrerpolicy="no-referrer" class="vemoji" src="' + o + '" />';
                return n.test(o) ? u : ""
            }
        };
        t.default = i
    ...
    , function(e, t, n) {
        ...
        function m(e, t) {
            ...
            var r = !Array.isArray(e)
              ...
              , o = !1;
            return {
                onIgnoreTag: function(e, r, u) {
                    if (n(e)) {
                        if (u.isClosing) {
                            var a = "[/removed]"
                              , s = u.position + a.length;
                            return i.push([!1 !== o ? o : u.position, s]),
                            o = !1,
                            a
                        }
                        return o || (o = u.position),
                        "[removed]"
                    }
                    return t(e, r, u)
                },
    ...
    , function(e, t, n) {
        ...
        function o(e, t, n) {
            ...
            e: for (l = 0; l < c; l++) {
                ...
                if (!1 === a) {
                    ...
                    if (">" === d) {
                        ...
                        p = e.slice(a, l + 1),
                        f = r(p),
                        o += t(a, o.length, f, p, i(p)),
                        u = l + 1,
                        a = !1;
                        continue
                    }
                    if ('"' === d || "'" === d)
                        for (var h = 1, g = e.charAt(l - h); "" === g.trim() || "=" === g; ) {
                            if ("=" === g) {
                                s = d;
                                continue e
                            }
            ...
            return u < e.length && (o += n(e.substr(u))),
            o
        }
        function u(e, t) {
            "use strict";
            ...
            for (var r = 0, i = [], o = !1, u = e.length, l = 0; l < u; l++) {
                var d, h, g = e.charAt(l);
                if (!1 !== o || "=" !== g)
                    if (!1 === o || l !== r || '"' !== g && "'" !== g || "=" !== e.charAt(l - 1))
                        if (/\s|\n|\t/.test(g)) {
                            if (e = e.replace(/\s|\n|\t/g, " "),
                            !1 === o) {
                                if (-1 === (h = a(e, l))) {
...
*/
    ...
    , function(e, t, n) {
        ...
        i.prototype._init = function() {
            ...
            try {
                var t = e.cfg
                  ...
                  , o = t.visitor
                  , u = t.path
                  , a = void 0 === u ? location.pathname : u
                  , s = t.pageSize
                  , l = t.recordIP;
                e.cfg.path = a.replace(/index\.html?$/, "");
                var c = $.ds
                  , f = r ? "&q=" + (0,
                h.RandomStr)() : "";
                ...
                if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
                    ...
                    e.$nodata = {
                        show: function(t) {
                            return v.html(t || e.i18n.t("sofa")).show(),
                            e
                        },
                        hide: function() {
                            return v.hide(),
                        ...
                        e.length > 0 && t.forEach(function(t) {
                            e.forEach(function(e) {
                                ...
                                if ((/\%/.test(o) ? o : encodeURI(o)) == n) {
                                    var u = i.find(".leancloud-visitors-count");
                                    u && u.text(r)
                                }
                            })
                        })
        ...
        i.prototype.Q = function(e) {
            ...
            if (1 == n) {
                ...
                o.equalTo("rid", "");
                var u = AV.Query.or(i, o);
                return "*" === e ? u.exists("url") : u.equalTo("url", decodeURI(e)),
                u.addDescending("createdAt"),
                u.addDescending("insertedAt"),
                u
            }
            var a = JSON.stringify(arguments[1]).replace(/(\[|\])/g, "")
              , s = "select * from " + r + " where rid in (" + a + ") order by -createdAt,-createdAt";
        ...
        i.prototype.bind = function() {
            var e = this
              ...
              , c = function(e) {
                var n = [];
                for (var r in u)
                    u.hasOwnProperty(r) && !!d.default.build(r) && n.push('<i title="' + r + '" >' + d.default.build(r) + "</i>");
                t.html(n.join("")),
                s = !0,
            ...
            var j = function() {
              ...
              , T = function(t, n, r) {
                ...
                u = o.version ? o.os ? '<span class="vsys">' + o.browser + " " + o.version + '</span> <span class="vsys">' + o.os + " " + o.osVersion + "</span>" : "" : '<span class="vsys">' + o.browser + "</span>"),
                ...
                a.default)(t.get("mail")) + $.params) + '">'
                  , p = f + '<div class="vh"><div class="vhead">' + c + " " + u + '</div><div class="vmeta"><span class="vtime" >' + (0,
                y.default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0,
              ...
              , P = function(t, n) {
                t.on("click", function(r) {
                    var i = t.attr("data-vm-id")
                      ...
                      , u = e.$el.find(".vwrap")
                      , a = "@" + A.default.escape(n.get("nick"));
                    (0,
                    A.default)('.vreply-wrapper[data-self-id="' + o + '"]').append(u).find(".cancel-reply").show(),
                    I = {
                        at: A.default.escape(a) + " ",
                        rid: i,
                        pid: o,
                        rmail: n.get("mail")
                    },
            ...
            var M = e.$el.find(".vsubmit")
              ...
              , Q = function() {
                ...
                I.rid) {
                    ...
                    n.set("rid", I.rid),
                    n.set("pid", r),
                    _.comment = O.replace("<p>", '<p><a class="at" href="#' + r + '">' + I.at + "</a> , ")
                }
                for (var i in _)
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            "[object Error]" === {}.toString.call(t)) {
                ...
                if (isNaN(n))
                    e.$el && e.$nodata.show('<div class="code-wrapper"><pre style="text-align:left;"> ' + JSON.stringify(t) + "</pre></div>");
                else {
                    var r = e.i18n.t("code-" + n)
                      , i = (r == "code-" + n ? void 0 : r) || t.message || t.error || "";
                    101 == n || -1 == n ? e.$nodata.show() : e.$el && e.$nodata.show('<div class="code-wrapper"><pre style="text-align:left;">Code ' + n + ": " + i + "</pre></div>")
                }
            } else
                e.$el && e.$nodata.show('<div class="code-wrapper"><pre style="text-align:left;">' + JSON.stringify(t) + "</pre></div>")
        }
    ...
    , function(e, t, n) {
        ...
        d.code = function(e, t) {
            return '<div class="code-wrapper"><pre><code class="hljs language-' + t + '">' + (t && hljs.getLanguage(t) ? hljs.highlight(t, e).value : s.default.escape(e)) + "</code></pre></div>"
        }
        ,
        i.marked.setOptions({
    ...
    , function(e, t, n) {
        ...
        !function(i) {
            ...
            function p(e, t) {
                e[t >> 5] |= 128 << t % 32,
                e[14 + (t + 64 >>> 9 << 4)] = t;
                var n, r, i, u, a, p = 1732584193, d = -271733879, h = -1732584194, g = 271733878;
                for (n = 0; n < e.length; n += 16)
                    r = p,
                    i = d,
                    u = h,
                    a = g,
                    p = s(p, d, h, g, e[n], 7, -680876936),
                    g = s(g, p, d, h, e[n + 1], 12, -389564586),
                    h = s(h, g, p, d, e[n + 2], 17, 606105819),
                    d = s(d, h, g, p, e[n + 3], 22, -1044525330),
                    p = s(p, d, h, g, e[n + 4], 7, -176418897),
                    g = s(g, p, d, h, e[n + 5], 12, 1200080426),
                    h = s(h, g, p, d, e[n + 6], 17, -1473231341),
                    d = s(d, h, g, p, e[n + 7], 22, -45705983),
                    p = s(p, d, h, g, e[n + 8], 7, 1770035416),
                    g = s(g, p, d, h, e[n + 9], 12, -1958414417),
                    h = s(h, g, p, d, e[n + 10], 17, -42063),
                    d = s(d, h, g, p, e[n + 11], 22, -1990404162),
                    p = s(p, d, h, g, e[n + 12], 7, 1804603682),
                    g = s(g, p, d, h, e[n + 13], 12, -40341101),
                    h = s(h, g, p, d, e[n + 14], 17, -1502002290),
                    d = s(d, h, g, p, e[n + 15], 22, 1236535329),
                    p = l(p, d, h, g, e[n + 1], 5, -165796510),
                    g = l(g, p, d, h, e[n + 6], 9, -1069501632),
                    h = l(h, g, p, d, e[n + 11], 14, 643717713),
                    d = l(d, h, g, p, e[n], 20, -373897302),
                    p = l(p, d, h, g, e[n + 5], 5, -701558691),
                    g = l(g, p, d, h, e[n + 10], 9, 38016083),
                    h = l(h, g, p, d, e[n + 15], 14, -660478335),
                    d = l(d, h, g, p, e[n + 4], 20, -405537848),
                    p = l(p, d, h, g, e[n + 9], 5, 568446438),
                    g = l(g, p, d, h, e[n + 14], 9, -1019803690),
                    h = l(h, g, p, d, e[n + 3], 14, -187363961),
                    d = l(d, h, g, p, e[n + 8], 20, 1163531501),
                    p = l(p, d, h, g, e[n + 13], 5, -1444681467),
                    g = l(g, p, d, h, e[n + 2], 9, -51403784),
                    h = l(h, g, p, d, e[n + 7], 14, 1735328473),
                    d = l(d, h, g, p, e[n + 12], 20, -1926607734),
                    p = c(p, d, h, g, e[n + 5], 4, -378558),
                    g = c(g, p, d, h, e[n + 8], 11, -2022574463),
                    h = c(h, g, p, d, e[n + 11], 16, 1839030562),
                    d = c(d, h, g, p, e[n + 14], 23, -35309556),
                    p = c(p, d, h, g, e[n + 1], 4, -1530992060),
                    g = c(g, p, d, h, e[n + 4], 11, 1272893353),
                    h = c(h, g, p, d, e[n + 7], 16, -155497632),
                    d = c(d, h, g, p, e[n + 10], 23, -1094730640),
                    p = c(p, d, h, g, e[n + 13], 4, 681279174),
                    g = c(g, p, d, h, e[n], 11, -358537222),
                    h = c(h, g, p, d, e[n + 3], 16, -722521979),
                    d = c(d, h, g, p, e[n + 6], 23, 76029189),
                    p = c(p, d, h, g, e[n + 9], 4, -640364487),
                    g = c(g, p, d, h, e[n + 12], 11, -421815835),
                    h = c(h, g, p, d, e[n + 15], 16, 530742520),
                    d = c(d, h, g, p, e[n + 2], 23, -995338651),
                    p = f(p, d, h, g, e[n], 6, -198630844),
                    g = f(g, p, d, h, e[n + 7], 10, 1126891415),
                    h = f(h, g, p, d, e[n + 14], 15, -1416354905),
                    d = f(d, h, g, p, e[n + 5], 21, -57434055),
                    p = f(p, d, h, g, e[n + 12], 6, 1700485571),
                    g = f(g, p, d, h, e[n + 3], 10, -1894986606),
                    h = f(h, g, p, d, e[n + 10], 15, -1051523),
                    d = f(d, h, g, p, e[n + 1], 21, -2054922799),
                    p = f(p, d, h, g, e[n + 8], 6, 1873313359),
                    g = f(g, p, d, h, e[n + 15], 10, -30611744),
                    h = f(h, g, p, d, e[n + 6], 15, -1560198380),
                    d = f(d, h, g, p, e[n + 13], 21, 1309151649),
                    p = f(p, d, h, g, e[n + 4], 6, -145523070),
                    g = f(g, p, d, h, e[n + 11], 10, -1120210379),
                    h = f(h, g, p, d, e[n + 2], 15, 718787259),
                    d = f(d, h, g, p, e[n + 9], 21, -343485551),
                    p = o(p, r),
                    d = o(d, i),
                    h = o(h, u),
                    g = o(g, a);
            ...
            function A(e, t, n) {
                return t ? n ? x(t, e) : w(t, e) : n ? D(e) : b(e)
            }
            void 0 !== (r = function() {
                return A
            }
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            new Promise(function(t, n) {
                ...
                u(e.body) && (e.url = e.url + "?" + ("get" == e.method ? u(e.body) : "")),
                ...
                s.send("post" == e.method ? e.body : "get" == e.method ? "" : u(e.body))
            }
            )
        }
        ;
        ...
        var r = function(e) {
            ...
            for (var i in r)
                if (r.hasOwnProperty(i))
                    for (var o = 0, u = r[i].length; o < u; o++) {
                        var a = r[i][o];
                        n[a] && (t[i] = a)
                    }
            var s = {
            ...
            get: function(e) {
                ...
                if (n.length > 1) {
                    for (var r = {}, i = 0, o = n.length; i < o; i++) {
                        var u = a(c.getItem(n[i]));
                        u && (r[n[i]] = u)
                    }
                    return r
                }
                return a(c.getItem(e))
            },
            clear: function() {
                return c.clear(),
                this
    ...
    , function(e, t, n) {
        ...
        !function(n, o) {
            var o = function(e, t, n) {
                function r(i, o, u) {
                    return u = Object.create(r.fn),
                    i && u.push.apply(u, i[t] ? [i] : "" + i === i ? /</.test(i) ? ((o = e.createElement(o)).innerHTML = i,
                    o.children) : o ? (o = r(o)[0]) ? o[n](i) : u : e[n](i) : i),
                    u
                }
                return r.fn = [],
                r.one = function(e, t) {
    ...
    , function(e, t, n) {
        ...
        function o(e) {
            ...
            e.onAttr = e.onAttr || u.onAttr,
            e.onIgnoreAttr = e.onIgnoreAttr || u.onIgnoreAttr,
        ...
        o.prototype.process = function(e) {
            ...
            var t = this
              ...
              , u = n.onIgnoreAttr
              , s = n.safeAttrValue;
            return a(e, function(e, t, n, a, l) {
                var c = i[n]
                  , f = !1;
                if (!0 === c ? f = c : "function" == typeof c ? f = c(a) : c instanceof RegExp && (f = c.test(a)),
                !0 !== f && (f = !1),
                a = s(n, a)) {
                    var p = {
                        position: t,
    ...
    , function(e, t, n) {
        function r(e, t) {
            function n() {
                if (!o) {
                    var n = i.trim(e.slice(u, a))
                      , r = n.indexOf(":");
                    if (-1 !== r) {
                        var l = i.trim(n.slice(0, r))
                          , c = i.trim(n.slice(r + 1));
                        if (l) {
                            var f = t(u, s.length, l, c, n);
                            f && (s += f + "; ")
                        }
                    }
                }
            ...
            e = i.trimRight(e),
            ";" !== e[e.length - 1] && (e += ";");
            for (var r = e.length, o = !1, u = 0, a = 0, s = ""; a < r; a++) {
                var l = e[a];
                if ("/" === l && "*" === e[a + 1]) {
                    var c = e.indexOf("*/", a + 2);
                    if (-1 === c)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            var t = o(e);
            return u(t) ? 0 : 0 !== t && a(t) ? s(t) * i(r(t)) : t
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
          ...
          , s = function(e, t) {
            ...
            var n, r, u, a = "string" === t ? ["toString", "valueOf"] : ["valueOf", "toString"];
        ...
        e.exports = function(e) {
            ...
            var n;
            if (r && (Symbol.toPrimitive ? n = l(e, Symbol.toPrimitive) : a(e) && (n = Symbol.prototype.valueOf)),
            void 0 !== n) {
                var o = n.call(e, t);
                if (i(o))
                    return o;
            ...
            return "default" === t && (u(e) || a(e)) && (t = "string"),
    ...
    , function(e, t, n) {
          ...
          , u = {
            "[[DefaultValue]]": function(e) {
                ...
                if ((t = arguments.length > 1 ? arguments[1] : "[object Date]" === r.call(e) ? String : Number) === String || t === Number) {
                    var n, u, a = t === String ? ["toString", "valueOf"] : ["valueOf", "toString"];
                    for (u = 0; u < a.length; ++u)
                        if (o(e[a[u]]) && (n = e[a[u]](),
                        i(n)))
                            return n;
        ...
        e.exports = function(e) {
            return i(e) ? e : arguments.length > 1 ? u["[[DefaultValue]]"](e, arguments[1]) : u["[[DefaultValue]]"](e)
        }
    }
    , function(e, t, n) {
        "use strict";
        ...
        e.exports = function(e) {
            ...
            for (var n, o = r.call(arguments, 1), u = function() {
                if (this instanceof n) {
                    var i = t.apply(this, o.concat(r.call(arguments)));
                    return Object(i) === i ? i : this
                }
                return t.apply(e, o.concat(r.call(arguments)))
            }, a = Math.max(0, t.length - o.length), s = [], l = 0; l < a; l++)
                s.push("$" + l);
            if (n = Function("binder", "return function (" + s.join(",") + "){ return binder.apply(this,arguments); }")(u),
            t.prototype) {
                var c = function() {};
    ...
    , function(e, t, n) {
        ...
        var r = Date.prototype.getDay
          ...
          , u = n(24)();
        e.exports = function(e) {
            return "object" == typeof e && null !== e && (u ? i(e) : "[object Date]" === o.call(e))
        }
    }
    , function(e, t, n) {
        "use strict";
        var r = String.prototype.valueOf
          ...
          , u = n(24)();
        e.exports = function(e) {
            return "string" == typeof e || "object" == typeof e && (u ? i(e) : "[object String]" === o.call(e))
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        !function(e, n) {
            ...
            function p(e, t) {
                T[" " + e] || (I.test(e) ? T[" " + e] = e + "/" : T[" " + e] = g(e, "/", !0)),
                e = T[" " + e];
                var n = -1 === e.indexOf(":");
                return "//" === t.substring(0, 2) ? n ? t : e.replace(P, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(z, "$1") + t : e + t
            }
            function d(e) {
            ...
            function A(e, t, n) {
                ...
                try {
                    var a = Q.lex(e, t);
                    return t.walkTokens && A.walkTokens(a, t.walkTokens),
                    V.parse(a, t)
                } catch (e) {
                    if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                    t.silent)
                        return "<p>An error occurred:</p><div class="code-wrapper"><pre>" + s(e.message + "", !0) + "</pre></div>";
                    throw e
                }
            }
            e.defaults = u();
            var k = /[&<>"']/
              ...
              , M = function() {
                ...
                n.code = function(e) {
                    ...
                    if (t) {
                        ...
                        return {
                            ...
                            text: this.options.pedantic ? n : g(n, "\n")
                        }
                    }
                }
                ,
                ...
                n.list = function(e) {
                    ...
                    if (t) {
                        var n, r, i, u, a, s, l, c, f, p, d, h, g = t[1].trim(), y = g.length > 1, v = {
                            type: "list",
                            raw: "",
                            ordered: y,
                            start: y ? +g.slice(0, -1) : "",
                        ...
                        g = y ? "\\d{1,9}\\" + g.slice(-1) : "\\" + g,
                        this.options.pedantic && (g = y ? g : "[*+-]");
                        for (var m = new RegExp("^( {0,3}" + g + ")((?: [^\\n]*)?(?:\\n|$))"); e && (h = !1,
                        t = m.exec(e)) && !this.rules.block.hr.test(e); ) {
                            ...
                            h = !0),
                            !h)
                                for (var D = new RegExp("^ {0," + Math.min(3, u - 1) + "}(?:[*+-]|\\d{1,9}[.)])"); e && (p = e.split("\n", 1)[0],
                                c = p,
                        ...
                        for (a = 0; a < b; a++) {
                            ...
                            var x = v.items[a].tokens.filter(function(e) {
                                return "space" === e.type
                            })
                    ...
                    if (t) {
                        ...
                        if (n.header.length === n.align.length) {
                            ...
                            i = 0; i < a; i++)
                                ...
                                o = 0; o < u.length; o++)
                                    u[o].tokens = [],
                                    this.lexer.inlineTokens(u[o].text, u[o].tokens);
                            return n
                        }
                    }
                }
                ...
                n.emStrong = function(e, t, n) {
                    ...
                        ...
                        if (!i || i && ("" === n || this.rules.inline.punctuation.exec(n))) {
                            var o, u, a = r[0].length - 1, s = a, l = 0, c = "*" === r[0][0] ? this.rules.inline.emStrong.rDelimAst : this.rules.inline.emStrong.rDelimUnd;
                            for (c.lastIndex = 0,
                            t = t.slice(-1 * e.length + a); null != (r = c.exec(t)); )
                                if (o = r[1] || r[2] || r[3] || r[4] || r[5] || r[6])
                                    ...
                                    r[3] || r[4])
                                        ...
                                        if (!((s -= u) > 0)) {
                                            if (u = Math.min(u, u + s + l),
                                            Math.min(a, u) % 2) {
                                                var f = e.slice(1, a + r.index + u);
                                                return {
                                                    type: "em",
            ...
            var Q = function() {
                    ...
                    if (this.tokens.links) {
                        ...
                        if (c.length > 0)
                            for (; null != (u = this.tokenizer.rules.inline.reflinkSearch.exec(l)); )
                                c.includes(u[0].slice(u[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, u.index) + "[" + m("a", u[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                    }
                    for (; null != (u = this.tokenizer.rules.inline.blockSkip.exec(l)); )
                        l = l.slice(0, u.index) + "[" + m("a", u[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                    for (; null != (u = this.tokenizer.rules.inline.escapedEmSt.exec(l)); )
                        l = l.slice(0, u.index) + "++" + l.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex);
                    for (; e; )
                        if (a || (s = ""),
                        a = !1,
              ...
              , U = function() {
                ...
                return n.code = function(e, t, n) {
                    ...
                    return e = e.replace(/\n$/, "") + "\n",
                    r ? '<div class="code-wrapper"><pre><code class="' + this.options.langPrefix + s(r, !0) + '">' + (n ? e : s(e, !0)) + "</code></pre></div>\n" : "<div class="code-wrapper"><pre><code class="hljs">" + (n ? e : s(e, !0)) + "</code></pre></div>\n"
                }
                ,
                n.blockquote = function(e) {
                    return "<blockquote>\n" + e + "</blockquote>\n"
              ...
              , V = function() {
                ...
                return n.parse = function(e, t) {
                    void 0 === t && (t = !0);
                    var n, r, i, o, u, a, s, c, f, p, d, h, g, y, v, m, D, b, x, w = "", A = e.length;
                    for (n = 0; n < A; n++)
                        if (p = e[n],
                        !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type]) || !1 === (x = this.options.extensions.renderers[p.type].call({
                            ...
                            case "table":
                                ...
                                r = 0; r < o; r++) {
                                    ...
                                    u = a.length,
                                    i = 0; i < u; i++)
                                        s += this.renderer.tablecell(this.parseInline(a[i].tokens), {
                                            header: !1,
                                            align: p.align[i]
                                        });
                            ...
                            case "list":
                                ...
                                r = 0; r < o; r++)
                                    ...
                                    D = v.task,
                                    y = "",
                                    v.task && (b = this.renderer.checkbox(m),
                                    g ? v.tokens.length > 0 && "paragraph" === v.tokens[0].type ? (v.tokens[0].text = b + " " + v.tokens[0].text,
                                    ...
                                    y += this.parse(v.tokens, g),
                                    f += this.renderer.listitem(y, D, m);
            ...
            A.use = function() {
                ...
                t.forEach(function(e) {
                    ...
                    e.renderer && function() {
                        var t = A.defaults.renderer || new U;
                            ...
                            !function(n) {
                                ...
                                t[n] = function() {
                                    for (var i = arguments.length, o = new Array(i), u = 0; u < i; u++)
                                        o[u] = arguments[u];
                                    var a = e.renderer[n].apply(t, o);
                                    return !1 === a && (a = r.apply(t, o)),
                                    a
                                }
                            }(n);
                        i.renderer = t
                    ...
                    !function() {
                        ...
                        case "table":
                            for (var r, i = o(e.header); !(r = i()).done; ) {
                                var u = r.value;
                                A.walkTokens(u.tokens, t)
                            }
                            for (var a, s = o(e.rows); !(a = s()).done; )
                                for (var l, c = a.value, f = o(c); !(l = f()).done; ) {
                                    var p = l.value;
    ...
    , function(e, t, n) {
        ...
        function s(e, t, n, r, i) {
            ...
            if (null != s.smart_count && e) {
                var l = i || b
                  ...
                  , f = n || "en"
                  , p = x(l, f)
                  , g = o(l, p, s.smart_count);
                u = h(c[g] || c[0])
            }
            return u = y.call(u, a, function(e, t) {
        ...
        function l(e) {
            ...
            this.warn = t.warn || g,
            this.tokenRegex = a(t.interpolation),
...
*/
    ...
    , function(e, t, n) {
        ...
        function u(e) {
            return !("[object Array]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function a(e) {
            return !("[object Date]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function s(e) {
            return !("[object RegExp]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function l(e) {
            return !("[object Error]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function c(e) {
            return !("[object String]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function f(e) {
            return !("[object Number]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function p(e) {
            return !("[object Boolean]" !== y(e) || fe && "object" == typeof e && fe in e)
        }
        function d(e) {
            if (ce)
        ...
        function v(e) {
            if (e.name)
                return e.name;
            var t = X.call(G.call(e), /^function\s*([\w$]+)/);
            return t ? t[1] : null
        }
        function m(e, t) {
            if (e.indexOf)
        ...
        function E(e, t) {
            if (e.length > t.maxStringLength) {
                ...
                return E(J.call(e, 0, t.maxStringLength), t) + r
            }
        ...
        function j(e, t) {
            ...
            var o, a = "function" == typeof se ? se(e) : [];
            if (ce) {
                o = {};
            ...
            for (var l in e)
                g(e, l) && (n && String(Number(l)) === l && l < e.length || ce && o["$" + l]instanceof Symbol || (ne.call(/[^\w$]/, l) ? r.push(t(l, e) + ": " + t(e[l], e)) : r.push(l + ": " + t(e[l], e))));
            if ("function" == typeof se)
                for (var c = 0; c < a.length; c++)
                    pe.call(e, a[c]) && r.push("[" + t(a[c]) + "]: " + t(e[a[c]], e));
            return r
        }
        var T = "function" == typeof Map && Map.prototype
          ...
          , P = T && I && "function" == typeof I.get ? I.get : null
          ...
          , U = Q ? WeakMap.prototype.has : null
        ...
        e.exports = function e(t, n, F, T) {
            function I(t, n, r) {
                ...
                r) {
                    ...
                    return g(R, "quoteStyle") && (i.quoteStyle = R.quoteStyle),
                    e(t, i, F + 1, T)
                }
                return e(t, R, F + 1, T)
            }
            var R = n || {};
            if (g(R, "quoteStyle") && "single" !== R.quoteStyle && "double" !== R.quoteStyle)
                throw new TypeError('option "quoteStyle" must be "single" or "double"');
            if (g(R, "maxStringLength") && ("number" == typeof R.maxStringLength ? R.maxStringLength < 0 && R.maxStringLength !== 1 / 0 : null !== R.maxStringLength))
                throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
            var M = !g(R, "customInspect") || R.customInspect;
            if ("boolean" != typeof M && "symbol" !== M)
                throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
            if (g(R, "indent") && null !== R.indent && "\t" !== R.indent && !(parseInt(R.indent, 10) === R.indent && R.indent > 0))
                throw new TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
            if (g(R, "numericSeparator") && "boolean" != typeof R.numericSeparator)
                throw new TypeError('option "numericSeparator", if provided, must be `true` or `false`');
            var Q = R.numericSeparator;
            if (void 0 === t)
                return "undefined";
            if (null === t)
                return "null";
            ...
            if (k(t)) {
                for (var X = "<" + te.call(String(t.nodeName)), ee = t.attributes || [], ne = 0; ne < ee.length; ne++)
                    X += " " + ee[ne].name + "=" + i(o(ee[ne].value), "double", R);
                return X += ">",
                t.childNodes && t.childNodes.length && (X += "..."),
                X += "</" + te.call(String(t.nodeName)) + ">"
            }
            if (u(t)) {
                if (0 === t.length)
                    return "[]";
                var ue = j(t, I);
                return V && !O(ue) ? "[" + $(ue, V) + "]" : "[ " + ie.call(ue, ", ") + " ]"
            }
            if (l(t)) {
                var se = j(t, I);
            ...
            if (!a(t) && !s(t)) {
                var ve = j(t, I)
                  , me = de ? de(t) === Object.prototype : t instanceof Object || t.constructor === Object
                  , De = t instanceof Object ? "" : "null prototype"
                  , be = !me && fe && Object(t) === t && fe in t ? J.call(y(t), 8, -1) : De ? "Object" : ""
                  , xe = me || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : ""
                  , we = xe + (be || De ? "[" + ie.call(re.call([], be || [], De || []), ": ") + "] " : "");
                return 0 === ve.length ? we + "{}" : V ? we + "{" + $(ve, V) + "}" : we + "{ " + ie.call(ve, ", ") + " }"
            }
            return String(t)
        }
        ;
        var ye = Object.prototype.hasOwnProperty || function(e) {
            return e in this
        }
    }
    , function(e, t, n) {
        ...
        if (!Object.keys) {
            ...
            r = function(e) {
                ...
                if (r && e.length > 0)
                    ...
                    for (var y in e)
                        p && "prototype" === y || !i.call(e, y) || f.push(String(y));
                if (s)
                    for (var v = h(e), m = 0; m < c.length; ++m)
                        v && "constructor" === c[m] || !i.call(e, c[m]) || f.push(c[m]);
                return f
            }
        }
        e.exports = r
    ...
    , function(e, t, n) {
        ...
        u.prototype.process = function(e) {
            ...
            if (n.stripIgnoreTagBody) {
                var v = s.StripTagBody(n.stripIgnoreTagBody, a);
                a = v.onIgnoreTag
            }
            var m = c(e, function(e, t, n, s, c) {
                var v = {
                    sourcePosition: e,
                    position: t,
                    isClosing: c,
                ...
                if (v.isWhite) {
                    ...
                    var D = i(s)
                      , b = o[n]
                      , x = f(D.html, function(e, t) {
                        var i = -1 !== p.indexOf(b, e)
                          , o = l(n, e, t, i);
                        if (!r(o))
                            return o;
                        if (i)
